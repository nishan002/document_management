# Generated by Django 5.0.3 on 2024-03-26 14:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='document',
            name='shared_with',
            field=models.ManyToManyField(related_name='shared_documents', through='document.DocumentAccess', to=settings.AUTH_USER_MODEL),
        ),
    ]
